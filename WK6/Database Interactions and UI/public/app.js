...
document.getElementById("add").addEventListener("click", function(event){
  ...
  req.open("GET",route + "?" + payload, true);
    ...
    //make sure if the response is valid
      ...
      //add variables appended to page
      ...
      //create the attributes for the delete
      ...
      //delete button set with the onClick action here
...
//function that is called when the table is reloaded
function loadTable(response){
   ...
   //for each item in the table it prints out the name, reps, weight, date, and lbs
   //reps is split for better formatting to match the dateString
...
//delete row function that calls it via AJAX
function deleteRow(id){
  ...
  req.send(null);
  //prevents the default action of sending null from occuring
  event.preventDefault();
}
